...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  ApiResponse query(ApiRequest request)")
	fmt.Fprintln(os.Stderr)
	os.Exit(0)
}
...
func main() {
	...
	client := api.NewApiService1Client(thrift.NewTStandardClient(iprot, oprot))
